 ...
 *
 * ,--------------------------------------------------.     ,--------------------------------------------------.
 * |  Esc   | 1  ! | 2  @ | 3  # | 4  $ | 5  % |  L2  |     |  L2  | 6  ^ | 7  & | 8  * | 9  ( | 0  ) | Bckspc |
 * |--------+------+------+------+------+-------------|     |------+------+------+------+------+------+--------|
 ...
 */
/*
 * ctlr+alt are out of the way
 * no (accessible) L2 on right hand
 * esc should be more accssible
 * `/~ should be esc
 *
 * hold F/A/J/; should reverse
 *
 * features: double: ` == ~
 *           tap l1: next key is l1
 *           hold l1: press is l1
 *           double l1: toggle layer
 *
 *           alt+4 == alt f4
 *
 * shortcuts:
...
[BASE] = KEYMAP(  // layer 0 : default
  // left hand
  KC_ESC,     KC_1,    KC_2,     KC_3,     KC_4,               KC_5,  MO(2),
  KC_TAB,     KC_Q,    KC_W,     KC_E,     KC_R,               KC_T,  KC_LBRC,
  KC_LCTL,    KC_A,    KC_S,     KC_D,     KC_F,               KC_G,
  KC_LSFT,    KC_Z,    KC_X,     KC_C,     KC_V,               KC_B,  MO(1),
  MO(2),      KC_GRV,  KC_QUOT,  KC_MINS,  KC_LGUI,
  ...
  // right hand
  MO(2),   KC_6,     KC_7,     KC_8,     KC_9,     KC_0,      KC_BSPC,
  KC_RBRC, KC_Y,     KC_U,     KC_I,     KC_O,     KC_P,      KC_BSLS,
           KC_H,     KC_J,     KC_K,     KC_L,     KC_SCLN,   KC_QUOT,
  MO(1),   KC_N,     KC_M,     KC_COMM,  KC_DOT,   KC_SLSH,   KC_RSFT,
                     KC_LGUI,  KC_LCBR,  KC_RCBR,  KC_LBRC,   KC_RBRC,
 ...
 *
 * ,--------------------------------------------------.           ,--------------------------------------------------.
 * |   ~    |  F1  |  F2  |  F3  |  F4  |  F5  |  L2  |           |  L2  |  F6  |  F7  |  F8  |  F9  |  F10 |   F11  |
 * |--------+------+------+------+------+-------------|           |------+------+------+------+------+------+--------|
 * |   `    |   !  |   @  |   {  |   }  |   |  |      |           |      | Home | PgUp |  End |      |      |   F12  |
 * |--------+------+------+------+------+------|      |           |      |------+------+------+------+------+--------|
 * |        |   #  |   $  |   (  |   )  |   `  |------|           |------| Left | Down |  Up  | Right|      |        |
